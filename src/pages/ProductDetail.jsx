...
export default function ProductDetail() {
  ...
  // Interactive invoice input fields
  ...
  // 🌟 LOADING GUARD: Halts rendering execution until product state data populates safely
  ...
  // 🌟 FIXED LOGIC LAYER: Safely pulls data arrays from the product state variable model
